#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/02/2013 16:30:21>
...
mod1 <- ToursMNARc(y, R, X, tau = 0.05, trace = 3)
mod3 <- ToursMNARc(y, R, X, tau = 0.3, trace = 3)
mod5 <- ToursMNARc(y, R, X, tau = 0.5, trace = 3)
mod7 <- ToursMNARc(y, R, X, tau = 0.7, trace = 3)
mod9 <- ToursMNARc(y, R, X, tau = 0.95, trace = 3)
