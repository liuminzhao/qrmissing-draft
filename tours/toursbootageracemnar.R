#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/08/2013 23:13:05>
...
write.table(result, file = "toursbootageracemnar-0808.txt", row.names = FALSE, col.names = FALSE)
sendEmail(subject="boot tours age race mnar", text="done", address="liuminzhao@gmail.com")
