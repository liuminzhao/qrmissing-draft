...
than regular random effects in longitudinal methods.  However, the
quantile regression. Moreover, due to their full parametric
specification for the full data, their model does not allow for
sensitivity analysis, which is a key component in inference for
incomplete data (NAS 2010).
...
$\bmath \gamma_j = (\gamma_{j0}, \gamma_{j2}, \ldots, \gamma_{jp})^T$,
\begin{displaymath}
...
when errors are not normal.
  ...
  \begin{sidewaystable}[ht]
    ...
    \caption{Scenario 1: MSE(MCSE) for coefficients estimates of
      ...
      'quantreg'. BZ stands for Bottai's approach.}\label{tab:simh2}
...
\subsection{Proof of Lemma \ref{sec:lemma}}
\label{sec:proof}
\begin{itemize}
\item Denote
  \begin{displaymath}
