#!/bin/Rscript
##' Time-stamp: <liuminzhao 05/16/2014 11:36:35>
...
sink('sim-mle-m1-mnar-mar-0516.txt')
rm(list = ls())
library(qrmissing)
library(xtable)
library(doMC)
...
write.table(result, file = "sim-mle-m1-mnar-mar-result-0516.txt", row.names = F, col.names = F)
sendEmail(subject="simulation-mle-m1-mnar-MAR", text="done", address="liuminzhao@gmail.com")
