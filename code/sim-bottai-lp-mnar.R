...
sink('sim-bottai-lp-mnar-0714.txt')
rm(list = ls())
source('BiMLESigma.R')
source('Bottai.R')
source('sendEmail.R')
...
write.table(result, file = "sim-lp-mnar-0714-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-lp-mnar-0714-result.txt')
