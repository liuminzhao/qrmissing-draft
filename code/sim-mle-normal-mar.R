#!/bin/Rscript
##' Time-stamp: <liuminzhao 05/14/2014 00:52:05>
...
##' 2014-05-07 redo original simulation

sink('sim-mle-normal-mar-0514.txt')
rm(list = ls())
library(qrmissing)
library(xtable)
library(doMC)
...
write.table(result, file = "sim-mle-normal-mar-result-0514.txt", row.names = F, col.names = F)
...
result <- read.table('sim-mle-normal-mar-result-0514.txt')
