#!/bin/Rscript
##' Time-stamp: <liuminzhao 05/07/2014 23:04:48>
...
sink('sim-mle-normal-mar-0507.txt')
rm(list = ls())
library(qrmissing)
library(xtable)
library(doMC)
...
write.table(result, file = "sim-mle-normal-mar-result-0507.txt", row.names = F, col.names = F)
...
result <- read.table('sim-mle-normal-mar-result-0507.txt')
