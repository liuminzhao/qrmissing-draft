...
result1a <- read.table('sim-mle-normal-mnar-mar-0514-result.txt')
result1b <- read.table('sim-normal-mnar-mar-0516-result.txt')
...
result1a <- read.table('sim-mle-t-mnar-mar-0514-result.txt')
result1b <- read.table('sim-t-mnar-mar-0516-result.txt')
...
result1a <- read.table('sim-mle-lp-mnar-mar-0514-result.txt')
result1b <- read.table('sim-lp-mnar-mar-0516-result.txt')
...
result1a <- read.table('sim-mle-m1-mnar-mar-result-0516.txt')
result1b <- read.table('sim-m1-mnar-mar-result-0516.txt')
