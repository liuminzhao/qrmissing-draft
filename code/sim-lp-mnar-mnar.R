#!/bin/Rscript
##' Time-stamp: <liuminzhao 04/22/2014 22:59:51>
...
sink('sim-lp-mnar-mnar-0422.txt')
rm(list = ls())
library(xtable)
library(qrmissing)
library(doMC)
...
write.table(result, file = "sim-lp-mnar-mnar-0422-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-lp-mnar-mnar-0422-result.txt')
