#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/08/2013 17:32:08>
...
sink('sim-lp-mnar-mnar-0808.txt')
rm(list = ls())
library(compiler)
library(quantreg)
library(rootSolve)
...
write.table(result, file = "sim-lp-mnar-mnar-0808-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-lp-mnar-mnar-0808-result.txt')
