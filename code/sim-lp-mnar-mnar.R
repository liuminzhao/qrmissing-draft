#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/26/2013 08:21:28>
...
sink('sim-lp-mnar-mnar-0826.txt')
rm(list = ls())
library(xtable)
library(qrmissing)
library(doMC)
...
write.table(result, file = "sim-lp-mnar-mnar-0826-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-lp-mnar-mnar-0826-result.txt')
