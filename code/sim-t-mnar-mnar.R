#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/28/2013 00:21:26>
...
write.table(result, file = "sim-t-mnar-mnar-0828-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-t-mnar-mnar-0828-result.txt')
