#!/bin/Rscript
##' Time-stamp: <liuminzhao 06/28/2014 23:02:28>
...
write.table(result, file = "sim-t-mnar-mnar-0626-result.txt", row.names = F, col.names = F)
...
## result <- read.table('sim-t-mnar-mnar-0626-result.txt')
