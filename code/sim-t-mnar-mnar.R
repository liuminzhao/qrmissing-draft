#!/bin/Rscript
##' Time-stamp: <liuminzhao 01/06/2015 20:51:42>
...
write.table(result, file = "sim-t-mnar-mnar-0101-result.txt", row.names = F, col.names = F)
...
## result <- read.table('sim-t-mnar-mnar-0101-result.txt')
