#!/bin/Rscript
##' Time-stamp: <liuminzhao 06/28/2014 22:53:18>
...
sink('sim-normal-mnar-mar-0626.txt')
rm(list = ls())
library(xtable)
library(qrmissing)
library(doMC)
...
write.table(result, file = "sim-normal-mnar-mar-0626-result.txt", row.names = F, col.names = F)
