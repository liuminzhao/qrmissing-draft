#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/26/2013 08:13:34>
...
sink('sim-normal-mnar-mar-0826.txt')
rm(list = ls())
library(xtable)
library(qrmissing)
library(doMC)
...
write.table(result, file = "sim-normal-mnar-mar-0826-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-normal-mnar-mar-0826-result.txt')
