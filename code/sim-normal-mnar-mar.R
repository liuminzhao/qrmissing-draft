#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/28/2013 00:17:12>
...
sink('sim-normal-mnar-mar-0828.txt')
rm(list = ls())
library(xtable)
library(qrmissing)
library(doMC)
...
write.table(result, file = "sim-normal-mnar-mar-0828-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-normal-mnar-mar-0828-result.txt')
