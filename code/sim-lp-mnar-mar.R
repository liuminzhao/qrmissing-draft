#!/bin/Rscript
##' Time-stamp: <liuminzhao 06/28/2014 22:55:28>
...
write.table(result, file = "sim-lp-mnar-mar-0626-result.txt", row.names = F, col.names = F)
...
## result <- read.table('sim-lp-mnar-mar-0626-result.txt')
