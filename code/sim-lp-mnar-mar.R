#!/bin/Rscript
##' Time-stamp: <liuminzhao 01/06/2015 21:23:51>
...
write.table(result, file = "sim-lp-mnar-mar-0101-result.txt", row.names = F, col.names = F)
...
## result <- read.table('sim-lp-mnar-mar-0101-result.txt')
