#!/bin/Rscript
##' Time-stamp: <liuminzhao 04/22/2014 22:59:21>
...
write.table(result, file = "sim-lp-mnar-mar-0422-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-lp-mnar-mar-0422-result.txt')
