#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/28/2013 00:24:47>
...
write.table(result, file = "sim-lp-mnar-mar-0828-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-lp-mnar-mar-0828-result.txt')
