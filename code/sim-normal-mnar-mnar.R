#!/bin/Rscript
##' Time-stamp: <liuminzhao 01/05/2015 21:31:38>
...
sink('sim-normal-mnar-mnar-0101.txt')
rm(list = ls())
library(qrmissing)
library(xtable)
library(doMC)
...
write.table(result, file = "sim-normal-mnar-mnar-result-0101.txt", row.names = F, col.names = F)
...
## result <- read.table('sim-normal-mnar-mnar-result-0101.txt')
