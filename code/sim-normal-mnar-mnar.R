#!/bin/Rscript
##' Time-stamp: <liuminzhao 06/28/2014 22:57:59>
...
sink('sim-normal-mnar-mnar-0626.txt')
rm(list = ls())
library(qrmissing)
library(xtable)
library(doMC)
...
write.table(result, file = "sim-normal-mnar-mnar-result-0626.txt", row.names = F, col.names = F)
...
## result <- read.table('sim-normal-mnar-mnar-result-0626.txt')
