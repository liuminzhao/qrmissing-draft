#!/bin/Rscript
##' Time-stamp: <liuminzhao 06/28/2014 22:54:29>
...
write.table(result, file = "sim-t-mnar-mar-0626-result.txt", row.names = F, col.names = F)
...
## result <- read.table('sim-t-mnar-mar-0626-result.txt')
