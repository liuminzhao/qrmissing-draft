#!/bin/Rscript
##' Time-stamp: <liuminzhao 01/06/2015 20:50:51>
...
write.table(result, file = "sim-t-mnar-mar-0101-result.txt", row.names = F, col.names = F)
sendEmail(subject="simulation-t-MNAR-MAR", text="done", address="liuminzhao@gmail.com")
...
## result <- read.table('sim-t-mnar-mar-0101-result.txt')
