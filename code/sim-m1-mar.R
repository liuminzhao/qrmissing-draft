#!/bin/Rscript
##' Time-stamp: <liuminzhao 06/28/2014 12:18:25>
...
write.table(result, file = "sim-m1-mar-result-0626.txt", row.names = F, col.names = F)
sendEmail(subject="simulation-m1-MAR", text="done", address="liuminzhao@gmail.com")
...
## result <- read.table('sim-m1-mar-result-0626.txt')
