#!/bin/Rscript
##' Time-stamp: <liuminzhao 05/14/2014 00:51:27>
...
sink('sim-mle-lp-mnar-mar-0514.txt')
rm(list = ls())
library(xtable)
library(qrmissing)
library(doMC)
...
write.table(result, file = "sim-mle-lp-mnar-mar-0514-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-mle-lp-mnar-mar-0514-result.txt')
