#!/bin/Rscript
##' Time-stamp: <liuminzhao 07/25/2013 01:24:26>
##' 2013/07/05
...
ToursMNAR <- function(y, R, X, tau = 0.5, niter = 1000,  method="heter2"){
  ...
  ## print(param)
  if (tau == 0.05) {
    param <- c(-0.0443085115011456, 0.023478106718838, 0.0480247041003945,
               0.665948721228804, 0.0171233576476653, -0.00291841619988958,
               -0.0328549139722676, 0.0996666256704279, -2.04404699323338, -0.0602814918765505,-0.491532850154404, -0.4250824973117, -0.575728713412588, -0.233043615364564,-0.0856268605090682, -0.585448449639026, -0.132462056915593,0.0121770495150898, 0.128742344288805, 0.721466063404288, 0.036,
0, 0, 0, -1.54296227554111, -0.0189856899299252, -0.67245301421591,
-0.564778142984794, 0, 0, 0, 0, 1.35224779168606, 0, 0.884090937807177)
  }
  if (tau == 0.3) {
...
0, 0, 0, 1.15633120323484, 0, 0.941387714428302)
  ...
  if (tau == 0.95) {
    param <- c(0.100003858433811, 0.00575176625779381, -0.0401214365536106,
0.909173684711942, 0.0797903969998639, 0.00535246082135916, -0.0280883714923807,
-0.0589075150516331, -3.24348465403179, 0.0179210958888785, 0.077957572752663,
0.164143749794082, -2.44673932146144, 0.127264446937188, 0.0045643679662606,
-1.37133113962651, 0.170074196952149, 0.000508495411866792, -0.0274607011405095,
0.907686040323649, 0.036, 0, 0, 0, -3.2313854741381, 0.00219509217680659,
0.125208847035301, 0.342025701521132, 0, 0, 0, 0, 1.17845151054296,
0, 0.944175080989041)
  }
