#!/bin/Rscript
##' Time-stamp: <liuminzhao 05/07/2014 23:28:54>
...
sink('sim-mle-lp-mnar-mnar-0507.txt')
rm(list = ls())
library(xtable)
library(qrmissing)
library(doMC)
...
write.table(result, file = "sim-mle-lp-mnar-mnar-0507-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-mle-lp-mnar-mnar-0507-result.txt')
