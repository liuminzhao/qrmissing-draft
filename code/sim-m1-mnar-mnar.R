#!/bin/Rscript
##' Time-stamp: <liuminzhao 06/28/2014 23:01:16>
...
sink('sim-m1-mnar-mnar-0626.txt')
rm(list = ls())
library(qrmissing)
library(xtable)
library(doMC)
...
write.table(result, file = "sim-m1-mnar-mnar-result-0626.txt", row.names = F, col.names = F)
...
## result <- read.table('sim-m1-mnar-mnar-result-0626.txt')
