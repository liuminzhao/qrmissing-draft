#!/bin/Rscript
##' Time-stamp: <liuminzhao 01/06/2015 21:27:32>
...
sink('sim-m1-mnar-mnar-0101.txt')
rm(list = ls())
library(qrmissing)
library(xtable)
library(doMC)
...
write.table(result, file = "sim-m1-mnar-mnar-result-0101.txt", row.names = F, col.names = F)
...
## result <- read.table('sim-m1-mnar-mnar-result-0101.txt')
