...
result1a <- read.table('sim-mle-normal-mnar-mnar-result-0514.txt')
result1b <- read.table('sim-normal-mnar-mnar-result-0516.txt')

trueq <- c(q11, q13, q15, q17, q19, q21, q23, q25, q27, q29)
trueq <- rep(trueq, 3)
mse <- rep(0, 60)
for (i in 1:60){
  mse[i] <- mean((result1a[,i] - trueq[i])^2)
}
msem1 <- rbind(matrix(mse[1:10], 2, 5), matrix(mse[11:20], 2, 5))

mse <- rep(0, 60)
for (i in 1:60){
  mse[i] <- mean((result1b[,i] - trueq[i])^2)
}
...
s3N <- cbind(c(msem1), c(msem2), c(mserq), c(msebb))
colnames(s3N) <- c('M1', 'M2', 'RQ', 'BB')
print(xtable(s3N))
print(s3N)
...
result1a <- read.table('sim-mle-t-mnar-mnar-0514-result.txt')
result1b <- read.table('sim-t-mnar-mnar-0516-result.txt')
...
s3t <- cbind(c(msem1), c(msem2), c(mserq), c(msebb))
colnames(s3t) <- c('M1', 'M2', 'RQ', 'BB')
print(xtable(s3t))
print(s3t)
...
result1a <- read.table('sim-mle-lp-mnar-mnar-0514-result.txt')
result1b <- read.table('sim-lp-mnar-mnar-0516-result.txt')
...
s3lp <- cbind(c(msem1), c(msem2), c(mserq), c(msebb))
colnames(s3lp) <- c('M1', 'M2', 'RQ', 'BB')
print(xtable(s3lp))
print(s3lp)
...
result1a <- read.table('sim-mle-m1-mnar-mnar-result-0516.txt')
result1b <- read.table('sim-m1-mnar-mnar-result-0516.txt')
...
s3mix <- cbind(c(msem1), c(msem2), c(mserq), c(msebb))
colnames(s3mix) <- c('M1', 'M2', 'RQ', 'BB')
print(xtable(s3mix))
print(s3mix)

## merge

s3tbl <- cbind(s3N, s3t, s3lp, s3mix)
print(xtable(s3tbl))
