...
result1 <- read.table('sim-normal-mnar-mnar-result-0626.txt')
...
result1 <- read.table('sim-t-mnar-mnar-0626-result.txt')
...
result1 <- read.table('sim-lp-mnar-mnar-0626-result.txt')
...
result1 <- read.table('sim-m1-mnar-mnar-result-0626.txt')
