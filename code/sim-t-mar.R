#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/13/2013 15:25:15>
...
write.table(result, file = "sim-t-mar-0808-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-t-mar-0808-result.txt')
