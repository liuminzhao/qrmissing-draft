#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/26/2013 08:19:41>
...
write.table(result, file = "sim-t-mar-0826-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-t-mar-0826-result.txt')
