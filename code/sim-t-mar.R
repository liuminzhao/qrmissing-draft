#!/bin/Rscript
##' Time-stamp: <liuminzhao 04/22/2014 22:57:36>
...
write.table(result, file = "sim-t-mar-0422-result.txt", row.names = F, col.names = F)
...
result <- read.table('sim-t-mar-0422-result.txt')
